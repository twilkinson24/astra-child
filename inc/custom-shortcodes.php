...
// Shortcode to check if the user is logged in
function int_check_if_user_logged_in( $atts = array(), $content = null ) {
	if(is_user_logged_in()) {
    // always return
		return $content;
	}
}
add_shortcode( 'is_user_logged_in', 'int_check_if_user_logged_in' );

// shortcode ex: [is_user_logged_out]I will show if logged out[/is_user_logged_out]
function int_check_if_user_logged_out( $atts = array(), $content = null ) {
	if(!is_user_logged_in()) {
    // always return
		return $content;
	}
}
add_shortcode( 'is_user_logged_out', 'int_check_if_user_logged_out' );